	...
	while ( $query->have_posts() ) {
		...
		<div class="latestDealsBox"> <!-- start b -->
			<div class="floatLeft pb10 mr10 two200by200">
				<img src="<?php bloginfo('template_directory') ?>/assets/images/shoe.png">
				<div class="f11 ctr80">
			...
			<div class="left pb10"> <!-- a -->
				<div caption="sale">Macy's <span>20% off</span> All Items coupon (+ Free Shipping on $99), <span>25% off</span> Sitewide coupon (+ Clearance Sale, deals from <span>$3</span>)
				</div>
